...
func main() {
	...
	execCommand("cp", "../test-fixtures/plugins/tflint-ruleset-foo"+fileExt(), "../test-fixtures/locals/.tofulint.d/plugins/tflint-ruleset-foo"+fileExt())
	...
	execCommand("cp", "../test-fixtures/plugins/github.com/terraform-linters/tflint-ruleset-bar/0.1.0/tflint-ruleset-bar"+fileExt(), "../test-fixtures/locals/.tofulint.d/plugins/github.com/terraform-linters/tflint-ruleset-bar/0.1.0/tflint-ruleset-bar"+fileExt())
	...
	pluginDir, err := homedir.Expand("~/.tofulint.d/plugins")
	if err != nil {
		panic(err)
	}
	...
	execCommand("go", "build", "-o", "../../integrationtest/inspection/plugin/.tofulint.d/plugins/tflint-ruleset-example"+fileExt(), "./sources/example/main.go")
}
